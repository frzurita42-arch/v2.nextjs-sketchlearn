...
const COMPONENT_REGISTRY = [
  ...
  item({ name: 'Registry search bar', kind: 'component', createdAt: '2026-07-17T15:30:00Z',
  ...
  item({ name: 'PagedTable', kind: 'component', createdAt: '2026-07-17T09:20:00Z',
    ...
    inputs: 'Props: headers, rows (strings or { node } cells), rowIds, onDelete, empty, big (double-size font). UI inputs: ‹ Prev / Next › pager, 👁 full-text popup on clipped cells, 🗑 per-row delete.',
