...
- PRIOR LESSONS — DO NOT REPEAT ACROSS A COURSE: if the instructions/context say certain topics or lessons were ALREADY covered in earlier lessons of this unit/course, treat them as KNOWN. Do NOT re-teach, re-define or re-derive them — a single one-line reinforcement is the most you may spend on them. Devote this lesson to ITS OWN objective and the NEW material, building forward like a later chapter that assumes the earlier chapters were read. Repeating a previous lesson's explanations is a failure.
