...
export interface AppState {
  ...
  slideSeed?: { topic?: string; slides?: number; customInstructions?: string; autoGenerate?: boolean; repoSlug?: string; repoRef?: string; repoTitle?: string; unitTitle?: string; lessonTitle?: string; lessonIndex?: number; lessonCount?: number; lessonSeq?: number; lessonSeqTotal?: number } | null;
  builderDraft?: any;
  ...
  builderSeed?: { artifact?: 'presentation' | 'repository'; subject?: string; title?: string; context?: string; sourcePrompt?: string; tone?: string; pages?: any[]; cards?: any[]; editSlug?: string; autoSuggest?: boolean; lessonPath?: boolean; docs?: { name: string; text?: string; dataUrl?: string }[] } | null;
