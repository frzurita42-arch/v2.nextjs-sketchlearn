...
export type Sticky = { slug: string; title: string; kind: string; runCost: number; reason?: string; recommended?: boolean; free?: boolean; page?: string; view?: string; emoji?: string; access?: 'free' | 'paid'; url?: string; thumb?: string; channel?: string; embed?: string; cycle?: boolean; desc?: string };
