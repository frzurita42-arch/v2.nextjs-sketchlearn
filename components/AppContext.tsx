...
export type ViewName = 'home' | 'path' | 'settings' | 'activity' | 'language' | 'chat' | 'stats' | 'dashboard' | 'cspath' | 'feed' | 'tools' | 'slides' | 'tool' | 'toolbuilder' | 'toolsettings' | 'moderators' | 'sandbox' | 'empty' | 'presrun' | 'appsettings' | 'users' | 'comments' | 'about';
